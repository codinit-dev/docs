...
<Columns cols={2}>
  <Card title="Netlify" icon="/assets/ai-icons/netlify.svg" href="/integrations/netlify">
    Deploy static sites, SPAs, and serverless functions with global CDN and continuous deployment.
  </Card>
  <Card title="Vercel" icon="/assets/ai-icons/vercel-icon-light.svg" href="/integrations/vercel">
