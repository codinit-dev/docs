...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/gerome-elassaad/codinit-app">
    Contribute to the open source project
  </Card>
  <Card title="Report a Bug" icon="bug" href="https://github.com/gerome-elassaad/codinit-app/issues">
