...
<Update label="October 14, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Complete MCP integration components and chat system enhancements" }}>
  ## New features
...
<Update label="October 10, 2025" tags={["New releases", "Improvements"]} rss={{ title: "LLM provider icon migration and dependency management" }}>
  ## New features
