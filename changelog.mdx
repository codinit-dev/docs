...
### Fixed
- LMStudio provider error handling and Docker host mapping
- LMStudio baseUrl configuration retrieval from provider settings
- Ollama provider error handling and Docker compatibility
- ESLint issues in LMStudio provider
...
### Added
- GPT-5.1, GPT-5 Mini, and GPT-5 Nano models to OpenAI provider
...
- GPT-5.2 Pro, GPT-5.2 Thinking, and GPT-5.2 Instant models to OpenRouter provider
- Claude Opus 4.5 model to Anthropic provider with enhanced capabilities
- Claude 4.5 models (Opus, Sonnet, Haiku) to Amazon Bedrock provider
- Fazier badge to header with theme-aware variants (dark and light modes)
- Local SVG assets for Fazier badge (embed_image_dark.svg, embed_image_light.svg)
...
### Fixed
- Fazier badge styling to prevent alt text display issues
- Badge width constraints to fit header layout properly
- Mixed static/dynamic import warning for CodeMirrorEditor component
- Vite configuration flags (v3_singleFetch) for better compatibility

### Removed
- Unused UI components to reduce bundle size:
...
- Duplicate service-status directory and components
- Duplicate TextShimmer.tsx and demo.tsx files
...
### Added
- Diff Approval Workflow with new `DiffApprovalDialog` component
- Live Action Console with `LiveActionAlert` component
- Inline diff comparison display for file changes
- Visual feedback for real-time action output
- Live streaming of command execution output
- New action status: "awaiting-approval"
- Fourth stream for live action monitoring
...
### Fixed
- Docker container name compatibility (changed wrangler.toml to lowercase)
- Model selection and provider dropdown functionality issues
- Preview header dropdown menu buttons and reload button
- UpdateTab with manual refresh capability and improved UI structure
- Live output callback wiring in workbench store
- Security vulnerabilities in GitHub Actions workflows (security.yaml with 120 lines)
- Context indicator accuracy for file categorization
- Message parsing for better artifact extraction

### Removed
- Walkthrough video file (walkthrough.mp4) to reduce repository size
- Unused 21st.jpeg image file
...
### Fixed
- Dark/light mode compatibility issues across entire application
...
- Icon button styling for cross-theme compatibility
- Vite dynamic import warnings by using static imports
- Infinite message loop in AI artifact generation
- React hooks violation in ProgressIndicator component
- Z-index layering for dropdowns above Preview component
- PortDropdown parent z-index stacking issue
- GitHub push button functionality in PreviewHeader
- Header z-index stacking issue in Electron builds
- Package.json rules to support both new and existing projects
- Styling tab layout with inline styles replacing dynamic classes

### Removed
- React Email package (no longer needed)
- Cohere provider from LLM registry
- Framework restrictions from AI prompts
- Duplicate ArtifactsStore (consolidated artifact management)
...
### Fixed
- Header alignment in Electron desktop builds
...
### Fixed
- ESLint consistent-return error in CustomTitleBar component
- Electron build compatibility issues
- GitHub Actions release workflow artifact collection
- Provider selection and error handling issues
- Title bar display across different platforms

### Removed
- Clerk authentication integration (complete rollback)
...
- MCP retry and validation API routes (72 total lines)
- Comprehensive coding rules prompt (785 lines, consolidated elsewhere)
- Provider validation test suite (160 lines)
- changelog.md duplicate file (35 lines)
- Amplitude and GTM provider wrapper overhead (4 lines combined)
- AGENTS.md file (55 lines, moved to different location)
...
### Fixed
- MCP service functionality and reliability issues
- Provider selection in chatbox
- Null provider error in Chat.client.tsx
- Linting errors in BaseChat component
- Electron environment variable handling
- Model dropdown issues in Electron app
- Header alignment and layout issues
- Switch button color states in dark mode

### Removed
- MCP integration panel (411 lines, replaced with new architecture)
- MCPToolApproval component (263 lines, moved to new location)
- MCPToolRegistry component (292 lines, moved to new location)
- MCPIntegrationPanel.module.scss (347 lines, redesigned)
- Legacy MCP JSON configuration file
- Test files (unit tests for base provider, manager, and diff utilities)
- AGENTS.md from root (55 lines)
- Cloudflare deploy API route (241 lines, consolidated)
...
- IconButton improvements (5 line changes)
  - Fixed border centering
  - Better styling consistency
- ControlPanel updates (4 line changes)
  - Better integration with new dialog system
...
- RepositorySelectionDialog refactor (79 line changes)
  - Better repository selection UX
  - Improved organization
- UpdateTab improvements (28 line changes)
  - Better update information display
  - Enhanced version checking
- AGENTS.md updates (14 line changes)
- Package updates (4 line changes in package.json)

### Fixed
- Client-side update check to handle 429 rate limiting gracefully
- Linting error in useUpdateCheck hook
- API route 429 rate limiting status code handling
- Dark mode color errors and inconsistencies
- IconButton border centering issues
- Settings icon button dropdown functionality
- Deployment icon display in PreviewHeader and DeployDialog
- Button styling consistency across workbench headers
- Action runner type reference (2 line fix)

### Removed
- Terminal button from CodeModeHeader (simplified interface)
...
- Preview component optimization (512 line reduction)
  - Extracted PreviewHeader to separate component
  - Streamlined preview logic
  - Reduced complexity
...
- Header component improvements (12 line changes)
  - Removed borders from header action buttons
...
- DiffView enhancements (10 line changes)
  ...
  - Improved UX
- EditorPanel updates (4 line changes)
- FileBreadcrumb improvements (2 line changes)
- LockManager updates (2 line changes)
- TerminalTabs enhancements (4 line changes)
- ChatAlert improvements (2 line changes)
- DeployAlert updates (2 line changes)
- ImportErrorModal fixes (2 line changes)
- ProgressCompilation improvements (9 line changes)
- Artifact component updates (4 line changes)
- README.md updates (3 line changes)

### Fixed
- Electron app model dropdown issue
  - Fixed provider selection
  - Improved model list rendering
  - Better state synchronization
- Header button styling consistency
- Workbench layout and integration issues
- UI component export in index.ts (1 line addition)
...
### Fixed
- Electron build configuration (2 line fixes)
  - Better icon references
  - Improved packaging
- Electron main process (2 line fixes)
  - Icon path corrections
- Windows icon display issues
  - Proper .ico format
...
### Removed
- readme_assets/readme.png (385KB, replaced with better screenshots)
- Duplicate icon files from /public root
...
### Fixed
- Default chat alerts functionality
...
- Model settings bar now collapsed by default
  - Cleaner initial UI
  - More screen space
  - Better UX
- Token config icon size and hard-coded colors removed
  - Theme-compatible icon
  - Better visual consistency
- Token config dropdown direction changed to open downwards
  - Better placement
  - Improved UX

### Removed
- Debug console.log statements from workbench
  - Cleaner console output
  - Better production readiness
- Debug console.log statements from action-runner
  - Reduced noise
...
### Fixed
- Message parser artifact detection (PR #14)
...
### Fixed
- Dropdown overlay z-index issues in ModelSelector
  - Fixed stacking context
  - Improved dropdown visibility
  - Better overlay handling
- Dropdown overlay issues in ChatBox
  - Corrected z-index layering
  - Enhanced dropdown positioning
- Missing API keys error handling
...
### Fixed
- Model selection persistence issues (PR #9)
...
### Fixed
- Docker repository name case issue
  - Changed to lowercase for compatibility
  - Added proper naming conventions
- Prettier formatting errors across codebase
...
### Removed
- CODEOWNERS file (1 line)
- CHANGES.md (92 lines, consolidated into CHANGELOG)
- CLAUDE.md from root (238 lines, moved to project-specific location)
- CONTRIBUTING.md (242 lines, consolidated)
- PROJECT.md (54 lines, information integrated elsewhere)
...
- Service integration component files (consolidated):
...
[1.1.26]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.25...v1.1.26
[1.1.25]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.24...v1.1.25
[1.1.24]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.23...v1.1.24
[1.1.23]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.22...v1.1.23
[1.1.22]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.20...v1.1.22
[1.1.20]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.19...v1.1.20
[1.1.19]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.18...v1.1.19
[1.1.18]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.17...v1.1.18
[1.1.17]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.16...v1.1.17
[1.1.16]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.15...v1.1.16
[1.1.15]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.14...v1.1.15
[1.1.14]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.13...v1.1.14
[1.1.13]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.12...v1.1.13
[1.1.12]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.11...v1.1.12
[1.1.11]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.1.10...v1.1.11
[1.1.10]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.10...v1.1.10
[1.0.10]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.9...v1.0.10
[1.0.9]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.8...v1.0.9
[1.0.8]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.7...v1.0.8
[1.0.7]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.6...v1.0.7
[1.0.6]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.5...v1.0.6
[1.0.5]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.4...v1.0.5
[1.0.4]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.3...v1.0.4
[1.0.3]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.2...v1.0.3
[1.0.2]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.1...v1.0.2
[1.0.1]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v1.0.0...v1.0.1
[1.0.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.7...v1.0.0
[0.9.7]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.6...v0.9.7
[0.9.6]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.5...v0.9.6
[0.9.5]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.4...v0.9.5
[0.9.4]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.3...v0.9.4
[0.9.3]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.2...v0.9.3
[0.9.2]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.1...v0.9.2
[0.9.1]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.9.0...v0.9.1
[0.9.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.8.0...v0.9.0
[0.8.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.7.0...v0.8.0
[0.7.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.6.0...v0.7.0
[0.6.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.5.0...v0.6.0
[0.5.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.2.0...v0.4.0
[0.2.0]: https://github.com/Gerome-Elassaad/codinit-dev/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/Gerome-Elassaad/codinit-dev/releases/tag/v0.1.0
