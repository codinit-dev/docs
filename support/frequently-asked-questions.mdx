...
description: "Find answers to common questions about CodinIT setup, model selection, features, integrations, and troubleshooting solutions."
---

Get answers to the most common questions about CodinIT's AI-powered development platform.

<Card title="Need Immediate Help?" icon="file-question-mark" horizontal href="#get-help--support">
...
<AccordionGroup>
   <Accordion title="What are the best models for CodinIT.dev?" icon="help-circle">
  ...
  <Accordion title="How do I configure API keys for different providers?" icon="command">
  ...
  <Accordion title="What are the latest xAI Grok models?" icon="zap">
    ...
    **Setup:**
    ...
    1. Get your API key from [xAI Platform](https://x.ai/docs/quickstart #creating-an-api-key)
...
<AccordionGroup>
  <Accordion title="How do I access help and documentation?" icon="mail-question-mark">
...
<AccordionGroup>
  ...
  <Accordion title="What are the future plans for CodinIT.dev?" icon="shield-question-mark">
    Visit our [Roadmap]() for the latest updates. New features and improvements are on the way!
  </Accordion>
  <Accordion title="Why are there so many open issues/pull requests?" icon="git-pull-request">
    CodinIT.dev began as a project on GitHub to explore editing open-source projects with local LLMs. However, it quickly grew into a massive community effort!
...
<AccordionGroup>
  ...
  <Accordion title="How do I use the new project templates?" icon="layout-template">
  ...
  <Accordion title="How does WebContainer work?" icon="chevrons-left-right-ellipsis">
...
<AccordionGroup>
  <Accordion title="There was an error processing this request" icon="ban">
  ...
  <Accordion title="Blank preview when running the app" icon="eye">
  ...
  <Accordion title="MCP server connection failed" icon="plug-zap">
  ...
  <Accordion title="WebContainer preview not loading" icon="scaling">
   ...
   <Accordion title="Received structured exception #0xc0000005: access violation" icon="monitor">
...
<CardGroup cols={2}>
  ...
  <Card title="Desktop Version Issues" icon="monitor-check">
